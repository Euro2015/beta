...
<div class="accordian-wrap">
    <div id="accordion">
        ...
        <div class="aorange accordian-box">
            <ul>
                <li>
                    <a href="site_videos/index-videos.php" class="clearfix"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/buttons/View-videos.png" alt='Goto tutorial videos button' height="19" width="30" />View demonstration videos</a>
                </li>
                <li>
                    <a href="javascript:void(0);" class="clearfix"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/buttons/Prize-draw.png" alt='Goto prize draw button' height="19" width="30" />Prize Details</a>
                </li>
                <li>
                    <a href="javascript:void(0);" class="clearfix"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/buttons/My-Account.png" alt='Goto my account button' height="19" width="30" />Go to my account</a>
                </li>
                <li>
                    <a href="javascript:void(0);" class="clearfix"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/buttons/How-to-navigate-button.png" alt='View how to navigate the site button' height="19" width="30" />Navigate the site</a>
                </li>
                <li>
                    <a href="javascript:void(0);" class="clearfix"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/buttons/How-to-list-button.png" alt='How to list your idea button' height="19" width="30" />How to list</a>
                </li>
                <li>
                    <a href="javascript:void(0);" class="clearfix"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/buttons/FAQ-button.png" alt='Goto to FAQ&#180;s button' height="19" width="30" />Frequently asked questions</a>
                </li>
            </ul>
        </div>
