    ...
    <!-- popup for feecback -->
        <div class="registration-box feedback_cont" style="top:40px !important">
            ...
            <input type="hidden" name="url" id="url" value="<?php echo Yii::app()->baseUrl;?>" />
                ...
                <div class="feedwrap">
                	<input type="text" name="email" id="email" class="feedbackinput" placeholder="<?php echo Yii::app()->baseUrl; ?>/register" />
                </div><?php */ ?>
                <div class="feed_heading">
                	<span class="span">
                    Message  
                    </span>
                     <a class="sl-tip tooltip" href="#;">?<span class="classic">Please enter details of the error that you
...
error.</span></a>
                ...
                <br /> 
                <div class="button_feed close_button">
                	<input type="button" name="yt0" id="close" tabindex="12"  class="button close black" value="Close" />
                </div>
                <div class="button_feed">
                	<input type="submit" name="yt0" tabindex="12" id="register-user" class="button black" value="Submit" />
                </div>
            </div>
            </form>
		</div>
