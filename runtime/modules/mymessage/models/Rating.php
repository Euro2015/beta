...
class Rating extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('user_id, msg_id, blist_id, rating', 'required'),
			array('user_id, msg_id, blist_id, rating', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, user_id, msg_id, blist_id, rating', 'safe', 'on'=>'search'),
		);
	}
